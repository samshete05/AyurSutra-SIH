...
const NFCFeatureCard = () => {
  ...
  // Pure card click se bhi same route pe jaayega
  const handleCardClick = () => {
    navigate("/nfc-card-at-ayursutra");
  };
  ...
  return (
    <section className="py-12 md:py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div
          className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 items-center bg-gradient-to-br from-emerald-50 to-white rounded-2xl p-6 md:p-10 border-2 border-emerald-200 hover:border-emerald-400 transition-all duration-300 cursor-pointer"
        ...
        >
          ...
          <div>
            ...
            {/* CTA Button - single Link, no nesting */}
            <Link
              to="/nfc-card-at-ayursutra"
              className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-6 py-3 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105 group text-sm md:text-base"
              onClick={(e) => e.stopPropagation()} // card click se conflict na ho
            >
              Learn More
              <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </Link>
