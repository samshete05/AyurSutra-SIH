...
const CenterCard = ({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl bg-white border border-[#1E4B3C]/15 shadow-sm hover:shadow-lg hover:border-[#1E4B3C]/60 transition-all duration-200 flex flex-col">
      {/* Top accent bar */}
