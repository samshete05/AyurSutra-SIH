        ...
        <main className="flex-1 bg-slate-100 px-4 py-4 md:px-8 md:py-6">
          ...
          <div className="mb-6 grid gap-4 md:grid-cols-4">
            {[
              ...
              <div
                key={kpi.title}
                className="rounded-2xl bg-white p-4 shadow-sm transition-all hover:-translate-y-2 hover:shadow-xl"
              >
                <p className="mb-2 text-xs font-semibold uppercase text-slate-400">{kpi.title}</p>
                <p className="mb-1 text-2xl font-semibold">{kpi.value}</p>
                <p className={`text-xs font-semibold ${kpi.trend.startsWith("+") ? "text-emerald-500" : "text-rose-500"}`}>
                  {kpi.trend}
                </p>
              </div>
            ))}
          ...
          <div className="grid gap-4 2xl:grid-cols-3 lg:grid-cols-2">
            <div className="rounded-2xl bg-white p-5 shadow-sm">
              ...
              <PKLineChart title="Revenue" unit="k" labels={monthLabels} values={revenueValues} color="#4F46E5" />
            </div>
            ...
            <div className="rounded-2xl bg-white p-5 shadow-sm">
              ...
              <PKLineChart title="Patients" labels={monthLabels} values={patientValues} color="#0EA5E9" />
            </div>
