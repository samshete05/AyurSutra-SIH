        ...
        <div className="max-w-6xl mx-auto px-4 py-12 flex-1">
          ...
          <section className="mb-8 animate-slideRight">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-1">
              ...
              <li>Anonymous website usage statistics, IP address, browser type, pages viewed, and time spent on our website</li>
              <li>Device information, operating system, and referral source</li>
              <li>Feedback, reviews, and survey responses</li>
              <li>Communications with our support team</li>
            </ul>
            <p className="text-gray-700 mt-2">
              We may also collect information required to comply with legal obligations, court orders, or requests from government authorities.
            </p>
          </section>
          ...
          <section className="mb-8 animate-fadeIn">
            ...
            <ul className="list-disc pl-6 text-gray-700">
              ...
              <li>To personalize your experience and recommend therapies</li>
              <li>To improve our website, services, and customer support</li>
              <li>To communicate with you about your bookings, updates, and offers</li>
              <li>To comply with legal obligations and protect our rights</li>
              <li>To analyze website traffic and usage patterns</li>
              <li>To administer surveys, contests, or promotions</li>
              <li>To ensure the security and integrity of our platform</li>
              <li>To prevent fraud, abuse, or other harmful activities</li>
              <li>To respond to queries from authorities if legally or morally obliged to comply</li>
            </ul>
          </section>
          ...
          <section className="mb-8 animate-slideLeft">
            ...
            <ul className="list-disc pl-6 text-gray-700 mt-2">
              ...
              <li>Analyze web traffic and marketing effectiveness</li>
              <li>Personalize your experience on our website</li>
              <li>Serve relevant advertisements and offers</li>
            </ul>
          </section>
          ...
          <section className="mb-8 animate-slideRight">
            ...
            <p className="text-gray-700">
              We do not sell, trade, or otherwise transfer your personal information to external agencies or parties except to trusted third parties who assist us in operating our website, conducting our business, or serving you, provided those parties agree to keep this information confidential. We may also release your information if required to comply with the law, enforce our policies, or protect our interests, property, or safety.
            </p>
          </section>
